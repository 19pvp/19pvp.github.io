...
UPDATE item_template
SET bonding = 1,
    description = IF(name <> 'Burnished Leggings', '', description),
...
UPDATE item_template
SET bonding = 1,
    description = IF(name <> 'Bluegill Breeches', '', description),
...
UPDATE item_template
SET bonding = 1,
    description = IF(name <> 'High Robe of the Adjudicator', '', description),
...
UPDATE item_template
SET bonding = 1,
    description = IF(name <> 'Double-stitched Woolen Shoulders', '', description),
...
UPDATE item_template
SET bonding = 1,
    description = IF(name <> 'Seer\'s Mantle', '', description),
    name = 'Seer\'s Mantle',
    Quality = 2,
    RandomProperty = 0,
    RandomSuffix = 0,
...
UPDATE item_template
SET bonding = 1,
    description = IF(name <> 'Legionnaire\'s Leggings', '', description),
...
UPDATE item_template
SET bonding = 1,
    description = IF(name <> 'Bashing Pauldrons', '', description),
...
UPDATE item_template
SET bonding = 1,
    description = IF(name <> 'Iridescent Hammer', '', description),
...
UPDATE item_template
SET bonding = 1,
    description = IF(name <> 'Robe of the Moccasin', '', description),
...
UPDATE item_template
SET bonding = 1,
    description = IF(name <> 'Stinging Viper', '', description),
    name = 'Stinging Viper',
    Quality = 2
WHERE entry = 6472;
...
UPDATE item_template
SET bonding = 1,
    description = IF(name <> 'Bandit Shoulders', '', description),
...
UPDATE item_template
SET bonding = 1,
    description = IF(name <> 'Mace of the Hand', '', description),
...
UPDATE item_template
SET bonding = 1,
    description = IF(name <> 'Scroll of Enchant Weapon - Unholy Weapon', '', description),
