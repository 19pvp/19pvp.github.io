...
import Wire from 'npm:bittorrent-protocol'
import createTorrent, { parseInput } from 'npm:create-torrent'
import debugFactory from 'npm:debug'
import { Client as DHT } from 'npm:bittorrent-dht' // browser exclude
...
import { hash, hex2arr, arr2hex, arr2base, text2arr, randomBytes, concat } from 'npm:uint8-util'
import throughput from 'npm:throughput'
import { ThrottleGroup } from 'npm:speed-limiter'
