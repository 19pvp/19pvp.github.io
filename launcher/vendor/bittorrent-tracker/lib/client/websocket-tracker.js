...
import Peer from 'npm:@thaunknown/simple-peer/lite.js'
import Socket from 'npm:@thaunknown/simple-websocket'
import { arr2text, arr2hex, hex2bin, bin2hex, randomBytes } from 'npm:uint8-util'
